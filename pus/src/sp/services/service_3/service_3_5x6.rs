...
impl Service3_5x6 {
    ...
    fn new(n: u8, report_ids: Vec<u8>) -> Result<Self, Error> {
        if report_ids.len() != n as usize {
            return Err(Error::InvalidPacket);
        }
        Ok(Service3_5x6 { n, report_ids })
    }
...
impl SpacePacket<TcPacket<Service3_5x6>> {
    ...
    pub(crate) fn new_service_3_5x6(
        ...
        let sec_header =
            TcPacketHeader::new((false, false, false, false), SERVICE_TYPE, mes_subtype, 42)?;
    ...
    pub(crate) fn from_bytes_service_3_5x6(buffer: &[u8]) -> Result<Self, Error> {
        ...
        let service_data: Service3_5x6 =
            Service3_5x6::from_bytes(&buffer[range_start..buffer.len() - PEC_LEN])?;
