...
impl Service3_25 {
    ...
    pub fn new(
        ...
        Ok(
            Service3_25{
               housekeeping_id,parameter_value
            }
        )
    }
    ...
    pub(crate) fn to_bytes(&self) -> Vec<u8>{
        let mut bytes = Vec::with_capacity(
            CONST_LEN_TOT + self.parameter_value.len()
        );
    ...
    fn get_packet_len(parameter_value:&Vec<u8>) -> usize {
        CONST_LEN_TOT + parameter_value.len() + TmPacketHeader::TM_HEADER_LEN + PrimaryHeader::PH_LEN + PEC_LEN
    }
...
impl SpacePacket<TmPacket<Service3_25>>{
    ...
    pub fn new_service_3_25(
        ...
        SpacePacket::<TmPacket::<Service3_25>>::new(destination_id,packet_name,housekeeping_id,parameter_value)
    }
    ...
    pub fn new(
        ...
        let sec_header = TmPacketHeader::new(
            SERVICE_TYPE,
            MES_SUBTYPE,
            destination_id
        )?;
    ...
    pub fn from_bytes(buffer:&[u8]) -> Result<Self,Error> {
        ...
        let service_data:Service3_25 = Service3_25::from_bytes(&buffer[range_start..buffer.len()-PEC_LEN])?;
