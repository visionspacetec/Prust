//!TC[3,5] create a housekeeping parameter report structure
use super::*;
use tc::{TcData, TcPacket,TcPacketHeader};

pub struct Service3_5{
    pub(crate) n:u8,
...
impl Service3_5 {
    /// For creating a TC[3,5] data structure
    ...
    /// For creating a TC[3,5] data structure. Wrapper of "new" function
    pub fn new_service_3_5(
        n:u8,
        report_ids:Vec<u8>
    ) -> Result<Self,Error> 
    {
        Service3_5::new(n,report_ids)
    }
...
impl SpacePacket<TcPacket<Service3_5>>{
    ...
    pub fn new_service_3_5(
        ...
        SpacePacket::<TcPacket::<Service3_5>>::new(apid,packet_name,n,report_ids)
    }

    /// For creating a TC[3,5] packet data structure 
    /// TODO: IMPORTANT ID'S ARE NOT CHECKED
    pub fn new(
        apid:u16,
        packet_name:u16,
        ...
        let data_len = Service3_5::get_packet_len(n);
        ...
        let data =Service3_5::new(n,report_ids)?;
        Ok(
            SpacePacket{
                primary_header,
                data:TcPacket{
                    header:sec_header,
                    user_data:TxUserData::<Service3_5>{
                        // TODO don't ignore
