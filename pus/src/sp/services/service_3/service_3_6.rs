...
const MES_SUBTYPE:u8 = 6;

/// Implementations of SpacePacket specific to PUS and TC[3,6]
/// 
/// # Errors
/// 
/// If not a valid CCSDS 133. 0-B-1 packet for TC[3,6].
...
impl SpacePacket<TcPacket<Service3_5x6>>{
    ...
    pub fn new_service_3_6(
        ...
        SpacePacket::<TcPacket::<Service3_5x6>>::new_service_3_5x6(
            MES_SUBTYPE,apid,packet_name,n,report_ids)
    }
    
    /// Wrapper for converting a TC[3,6] packet from bytes
    pub fn from_bytes_service_3_6(buffer:&[u8]) -> Result<Self,Error> {
