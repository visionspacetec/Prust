...
impl TcPacketHeader {
    ...
    pub fn to_bytes(&self) -> [u8;TcPacketHeader::TC_HEADER_LEN]{
        ...
        if self.acknowledgement_flags.0 { ver_no_and_flags += 0b0000_0001};
        if self.acknowledgement_flags.1 { ver_no_and_flags += 0b0000_0010};
        if self.acknowledgement_flags.2 { ver_no_and_flags += 0b0000_0100};
        if self.acknowledgement_flags.3 { ver_no_and_flags += 0b0000_1000};
